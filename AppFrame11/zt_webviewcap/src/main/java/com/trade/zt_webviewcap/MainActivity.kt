...
private fun EntryScreen(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Button(
            onClick = {
                context.startActivity(Intent(context, ComposeCaptureActivity::class.java))
            },
            modifier = Modifier.fillMaxWidth()
        ) {
            Text(stringResource(R.string.entry_compose))
        }
        Button(
            onClick = {
                context.startActivity(Intent(context, XmlCaptureActivity::class.java))
            },
            modifier = Modifier.fillMaxWidth()
        ) {
            Text(stringResource(R.string.entry_xml))
        }
    }
}
